...
import {
  ...
  import ModalTenant from 'components/Backoffice/Tenant/modal_tenant';
...
const TenantPage: React.FC<iTenantPage> = (datum) =>{
    ...
    const handleDeleteData= async (id:string) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                await handleDelete(Api.apiClient + `tenant/${id}`, async () => {});
            } else {
              Swal.close();
            }
          })
    ...
    return (
        <Layout title="Tenant">
                ...
                <br/>
                        ...
                        <thead>
                            <tr className="text-left border-b border-gray-300">
                                ...
                                <th className="px-4 py-3">tenant_slug</th>
                        ...
                        <tbody>
                            ...
                            datumTenant?.length>0?datumTenant.map((item:iTenant,i:number)=>{
                                    ...
                                    <tr className="bg-gray-700 border-b border-gray-600">
                                        ...
                                        <td className="px-4 py-4"><img src={item.logo} alt="img"/></td>
                                    </tr>
                                    );
            ...
            <ModalTenant open={openTenantModal} closeModal={() => setOpenTenantModal(false)} data={tenantData} />
        </Layout>
      );
}
