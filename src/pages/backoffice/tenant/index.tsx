    ...
    <Layout title="Tenant">
      <div className="container mt-6 px-2 lg:px-7 mx-auto grid mb-20">
        <div className="flex justify-between">
          <div>
            <h2 className="mt-6 text-2xl align-middle font-semibold text-gray-700 dark:text-gray-200">Tenant</h2>
          </div>
        </div>
        <div className="shadow-md rounded my-6">
          ...
          <div className="w-full overflow-x-auto">
            <table className="rounded-t-lg m-5 w-full mx-auto bg-gray-800 text-gray-200">
              ...
              <tbody>
                {datumTenant?.length > 0 ? (
                  datumTenant.map((item: iTenant, i: number) => {
                    return (
