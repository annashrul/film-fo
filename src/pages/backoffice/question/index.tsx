...
import {
  ...
  import ModalQuestion from 'components/Backoffice/Question/modal_question';
...
const QuestionPage: React.FC<iQuestionPage> = (datum) =>{
    ...
    const handleDeleteData= async (id:string) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                await handleDelete(Api.apiClient + `question/${id}`, async () => {});
            } else {
              Swal.close();
            }
          })
    ...
    return (
        <Layout title="Question">
                ...
                <br/>
                        ...
                        <thead>
                            <tr className="text-left border-b border-gray-300">
                                ...
                                <th className="px-4 py-3">Slug project</th>
            ...
            <ModalQuestion open={openQuestionModal} closeModal={() => setOpenQuestionModal(false)} data={questionData} />
        </Layout>
      );
}
